c  
c     mpiP MPI Profiler ( http://www.llnl.gov/CASC/mpip/ )
c  
c     Please see COPYRIGHT AND LICENSE information at the end of this file.
c  
c     ----- 
c  
c     sweep-ops.f -- FORTRAN test using sweep3D mpi features
c  
...
c      include mpif.h
     ...
     &     MPI_MAX,MPI_COMM_WORLD,ierr)
      print *,'allreduce double p placed ', rdarray(1), ' in rarray(1)'
